//okreœlenie rozmiaru pola planszy
...
//funkcja okreœlaj¹ca wartoœci pocz¹tkowe gracza

var Mover = function() {
    this.position = new PVector(width/2, height/2); //okreœlamy pozycjê pocz¹tkow¹ gracza
...
//************************************** FUNKCJA OBLICZAJ¥CA GRAWITACJÊ ************************************************
...
// ************************************** FUNKCJA SPRAWDZAJ¥CA KRAWÊDZIE ***********************************************
...
draw = function() {
    ...
    if(mover.position.y > 499 && keyPressed && keyCode === UP){
        mover.velocity.y -= 0.01;
        mover.acceleration.y -= 5;
    }
